...
A domain capability: discipline Precipitation Science inside the Hydrosphere sphere, also serving Atmosphere. Pillar means sphere: one of the five Earth science spheres; a capability is skills, knowledge signed by its stewards and deterministic checks, delivered as one plugin.
